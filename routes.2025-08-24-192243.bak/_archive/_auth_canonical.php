...
Route::middleware(['web','guest'])->group(function () {
    Route::get('/org/login',    fn() => view('org.login', ['type' => 'organization']))->name('org.login')->middleware('guest');
    Route::get('/org/register', fn() => redirect('/register?type=organization'))->name('org.register')->middleware('guest');
});

// __VOLUNTEER_ALIASES__
Route::get('/volunteer/login',    fn() => redirect('/login?type=volunteer'));
Route::get('/volunteer/register', fn() => redirect('/register?type=volunteer'));

// __ORG_AUTH_ROUTES__
Route::get('/org/login',    fn() => view('org.login', ['type' => 'organization']))->name('org.login')->middleware('guest');
Route::get('/org/register', fn() => view('org.register'))->name('org.register')->middleware('guest');
