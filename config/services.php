...
return [
    ...
    'recaptcha' => [
        'enabled'  => (bool) env('RECAPTCHA_SITE_KEY') && (bool) env('RECAPTCHA_SECRET'),
        'site_key' => env('RECAPTCHA_SITE_KEY'),
        'secret'   => env('RECAPTCHA_SECRET')
    ],
    // === SwaedUAE OAuth providers (do not remove) ===
    'google' => [
    ...
    // NOTE: UAE PASS will need a custom Socialite driver later;
    // we keep config+toggle here so buttons can be hidden/shown.
    'uaepass' => [
        'enabled' => env('OAUTH_UAEPASS_ENABLED', false),
        'client_id' => env('UAEPASS_CLIENT_ID'),
        'client_secret' => env('UAEPASS_CLIENT_SECRET'),
        'redirect' => env('UAEPASS_REDIRECT'),
