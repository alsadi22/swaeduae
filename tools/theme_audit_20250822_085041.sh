...
grep -nE "@include\(['\"]argon_front[/_]+_footer['\"]\)" resources/views/layouts/app.blade.php || true
grep -nE "@include(?:If)?\(['\"]components\.footer['\"]\)" resources/views/layouts/app.blade.php || true
...
ls -1 resources/views/*footer*.blade.php resources/views/**/*footer*.blade.php 2>/dev/null || true
