      ...
      @foreach($cats as $cat)
        <div class="col-6 col-md-4 col-lg-3">
          <a class="card p-3 hover-shadow text-decoration-none"
             href="{{ \Illuminate\Support\Facades\Route::has('public.opportunities') ? IlluminateSupportFacadesRoute::has('public.opportunities') ? route('opportunities.index') : url('/opportunities') : url('/opportunities') }}?category={{ urlencode($cat) }}">
