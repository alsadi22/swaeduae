        ...
        <div class="row align-items-center cs_gap_y_40">
          ...
          <div class="col-lg-6 offset-lg-1">
            <div class="cs_section_heading cs_style_1">
              ...
              <h2 class="cs_section_title cs_semibold cs_fs_56 mb-0 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">We are Professional Planners For your </h2>
            </div>
        ...
        <div class="row cs_gap_y_40 wow fadeIn" data-wow-duration="0.8s" data-wow-delay="0.2s">
          <div class="col-lg-3 col-sm-6">
            <div class="cs_iconbox cs_style_1">
              ...
              <p class="cs_iconbox_subtitle mb-0">We deliver the best service and you to <br>experience for our customer we est <br>service and you to experie</p>
            </div>
          </div>
          <div class="col-lg-3 col-sm-6">
            <div class="cs_iconbox cs_style_1">
        ...
        <div class="row cs_gap_y_40">
          ...
          <div class="col-lg-5 offset-lg-1">
            <div class="cs_section_heading cs_style_1">
              ...
              <h2 class="cs_section_title cs_semibold cs_fs_56 mb-0">Discover The World With Our Guide</h2>
              <p class="cs_section_subtitle">Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC.</p>
            </div>
            <div class="cs_height_55 cs_height_lg_40"></div>
            <div class="row cs_gap_y_24 position-relative">
              ...
              <div class="col-sm-6">
                <div class="cs_funfact cs_style_1 text-center">
                  <h3 class="cs_funfact_title cs_fs_40 cs_semibold cs_accent_color"><span class="odometer" data-count-to="502"></span>+</h3>
                  <p class="cs_funfact_subtitle mb-0 cs_fs_18">Holiday Package</p>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="cs_funfact cs_style_1 text-center">
                  <h3 class="cs_funfact_title cs_fs_40 cs_semibold cs_accent_color"><span class="odometer" data-count-to="100"></span>+</h3>
                  <p class="cs_funfact_subtitle mb-0 cs_fs_18">Luxury Hotel</p>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="cs_funfact cs_style_1 text-center">
                  <h3 class="cs_funfact_title cs_fs_40 cs_semibold cs_accent_color"><span class="odometer" data-count-to="77"></span>k</h3>
                  <p class="cs_funfact_subtitle mb-0 cs_fs_18">Premium Airlines</p>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="cs_funfact cs_style_1 text-center">
                  <h3 class="cs_funfact_title cs_fs_40 cs_semibold cs_accent_color"><span class="odometer" data-count-to="2"></span>k+</h3>
                  <p class="cs_funfact_subtitle mb-0 cs_fs_18">Happy Customer</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="cs_grid_1">
          <div class="cs_grid_item">
            <a href="{{ route('events.index') }}" class="cs_card cs_style_2 cs_zoom position-relative cs_radius_8">
    ...
    <section>
      ...
      <div class="container">
        <div class="cs_section_heading cs_style_1 text-center">
          ...
          <h2 class="cs_section_title cs_semibold cs_fs_56 mb-0 wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">Getting Started? It’s Simple</h2>
        </div>
        <div class="cs_height_55 cs_height_lg_40"></div>
        <div class="cs_steps cs_style_1">
          <div class="cs_step text-center position-relative">
            <div class="cs_step_thumb rounded-circle position-relative">
              ...
              <span class="cs_step_number cs_semibold text-white cs_fs_25 rounded-circle cs_accent_bg d-flex align-items-center justify-content-center position-absolute">01</span>
            </div>
          ...
          <div class="cs_step text-center position-relative">
            <div class="cs_step_thumb rounded-circle position-relative">
              ...
              <span class="cs_step_number cs_semibold text-white cs_fs_25 rounded-circle cs_accent_bg d-flex align-items-center justify-content-center position-absolute">02</span>
            </div>
          ...
          <div class="cs_step text-center position-relative">
            <div class="cs_step_thumb rounded-circle position-relative">
              ...
              <span class="cs_step_number cs_semibold text-white cs_fs_25 rounded-circle cs_accent_bg d-flex align-items-center justify-content-center position-absolute">03</span>
            </div>
        ...
        <div class="row cs_gap_y_24">
          <div class="col-lg-6">
            <article class="cs_post cs_style_1">
              <a href="{{ route('events.index') }}" class="cs_post_thumb cs_zoom overflow-hidden position-relative">
              ...
              <div class="cs_post_info">
                <div class="cs_post_info_in">
                  ...
                  <h2 class="cs_post_title cs_fs_24 cs_semibold"><a href="{{ route('events.index') }}">Useful VS Code Esions Front- End Develop</a></h2>
                  <p class="cs_post_subtitle">Lorem ipsum dolor sit amet, atomorum ds sosidon ium est as Id vim rrem princi pes suas molesti interpretaris</p>
            ...
            <article class="cs_post cs_style_1">
              ...
              <div class="cs_post_info">
                <div class="cs_post_info_in">
                  ...
                  <h2 class="cs_post_title cs_fs_24 cs_semibold"><a href="{{ route('events.index') }}">Designing Better Linke Website And Email</a></h2>
                  <p class="cs_post_subtitle">Lorem ipsum dolor sit amet, atomorum ds sosidon ium est as Id vim rrem princi pes suas molesti interpretaris</p>
                  <div class="cs_post_btns cs_gray_bg_1">
                    <a href="#">
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <mask id="mask0_346_344" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="20" height="20">
                        <rect width="20" height="20" fill="#D9D9D9"/></mask>
                        <g mask="url(#mask0_346_344)"><path d="M1.66675 18.3337V3.33366C1.66675 2.87533 1.83008 2.48283 2.15675 2.15616C2.48286 1.83005 2.87508 1.66699 3.33341 1.66699H16.6667C17.1251 1.66699 17.5176 1.83005 17.8442 2.15616C18.1704 2.48283 18.3334 2.87533 18.3334 3.33366V13.3337C18.3334 13.792 18.1704 14.1845 17.8442 14.5112C17.5176 14.8373 17.1251 15.0003 16.6667 15.0003H5.00008L1.66675 18.3337ZM3.33341 14.3128L4.31258 13.3337H16.6667V3.33366H3.33341V14.3128Z" fill="currentColor"/></g>
                      </svg> Comment(5)
                    </a>
                    <a href="{{ route('events.index') }}" class="cs_post_btn cs_primary_bg">
...
{{-- ==== SAFE SHORT-CIRCUIT (diagnostic) ==== --}}
@isset($__SAFE_HOME__)
  @extends('layout.layout')
  @section('content')
    <div class="container py-5">
      <h2>Homepage (temporary safe mode)</h2>
      <p>Layout & assets are OK. We’ll re-enable the full homepage after we fix the offending section.</p>
    </div>
  @endsection
  @php(exit) @endphp
@endisset
