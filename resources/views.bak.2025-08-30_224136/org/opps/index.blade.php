...
@section('content')
  ...
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="{{ route('org.opportunities.create') }}" class="btn btn-teal">
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <div class="card h-100">
            ...
            <div class="card-footer d-flex gap-2">
              <a href="{{ route('org.opportunities.edit', $op) }}" class="btn btn-sm btn-outline-primary">
                <i class="bi bi-pencil"></i> {{ __('Edit') }}
              </a>
              <form method="POST" action="{{ route('org.opportunities.destroy', $op) }}"
              ...
              <a href="{{ route('opps.public.show', $op) }}" class="btn btn-sm btn-light ms-auto">
                {{ __('View public') }}
              </a>
            </div>
          </div>
  ...
  @else
    <div class="empty-state">
      ...
      <a href="{{ route('org.opportunities.create') }}" class="btn btn-teal">{{ __('Create your first opportunity') }}</a>
    </div>
  @endif
@endsection
