@php
@php($logoutRoute = IlluminateSupportFacades\Route::has("admin.logout") ? "admin.logout" : (IlluminateSupportFacades\Route::has("logout") ? "logout" : null))
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        ...
        <form id="logout-form" action="{{ route($logoutRoute) }}" method="POST" class="d-none">@csrf</form>
      </li>
    </ul>
  </div>
</aside>
...
<form method="POST" action="{{ route($logoutRoute) }}" class="px-3 mt-3">
  @csrf
