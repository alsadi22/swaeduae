...
class OrgAuthController extends Controller {
  ...
  public function showRegister() { return view()->exists('org.auth.register') ? view('org.auth.register') : (view()->exists('org.auth.register') ? view('org.auth.register') : response('Org register',200)); }
