...
// LEGACY DISABLED:         Route::post('opportunities/{id}/attendance/manual', [\App\Http\Controllers\Admin\AttendanceAdminController::class, 'manual'])->name('attendance.manual');
// LEGACY DISABLED:         Route::post('opportunities/{id}/attendance/finalize', [\App\Http\Controllers\Admin\AttendanceAdminController::class, 'finalize'])->name('attendance.finalize');
