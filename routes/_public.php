...
Route::get('/about', function () { return view('static.about'); })->name('pages.about');
Route::get('/faq', function () { return view('static.faq'); })->name('pages.faq');
Route::get('/privacy', function () { return view('static.privacy'); })->name('pages.privacy');
Route::get('/terms', function () { return view('static.terms'); })->name('pages.terms');
