...
</head><body style="font-family:system-ui;max-width:520px;margin:64px auto">
<h2>Admin Sign In</h2>
@if ($errors->any())
  <div style="color:#b00020;margin:8px 0">@foreach ($errors->all() as $e)<div>{{ $e }}</div>@endforeach</div>
@endif
